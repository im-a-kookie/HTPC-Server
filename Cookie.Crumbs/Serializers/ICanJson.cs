...
namespace Cookie.Serializing
{
    ...
    {
        public string GetTargetIdentifier(JsonSerialization engine);

        public Dictionary<string, object> ToCompoundableDictionary(JsonSerialization engine)
        {
        ...
        public void FromCompound(JsonSerialization engine, Dictionary<string, object> dict)
        {

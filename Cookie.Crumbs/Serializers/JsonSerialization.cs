...
namespace Cookie.Serializing
{
    public class JsonSerialization
    {
        ...
        /// identifier tags in <see cref="ICanJson.GetTargetIdentifier(JsonSerialization)"/> and 
        /// </summary>
        ...
        public JsonSerialization(HostMode mode = HostMode.BACKEND)
        {
            this.Mode = mode;
        }
        ...
        /// <summary>
        /// Registers a builder for the given unique ID, which is provided by <see cref="ICanJson.GetTargetIdentifier(JsonSerialization)"/>
        /// </summary>
        /// <param name="ID"></param>
